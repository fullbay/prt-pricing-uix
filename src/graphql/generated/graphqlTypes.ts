...
export type CalculationMethod = "margin" | "markup";
...
export type PricingState = "active" | "archived" | "deleted";
...
export type CreatePartPricingScaleMutation = {
  createPartPricingScale: {
    ...
    createdAt: number;
    updatedAt: number;
    tiers: Array<{ minAmount: number; percent: number }>;
  };
};
...
export type DeletePartPricingScaleMutation = {
  deletePartPricingScale: boolean;
};
...
export type GetPartPricingScaleQuery = {
  getPartPricingScale: {
    pricingScaleId: string;
    accountId: string;
    name: string;
...
export type ListPartPricingScalesQuery = {
  listPartPricingScales: Array<{
    pricingScaleId: string;
    accountId: string;
    name: string;
    calculatedBasedOn: CalculationMethod;
...
export type UpdatePartPricingScaleMutation = {
...
export const CreatePartPricingScaleDocument = gql`
  mutation CreatePartPricingScale(
    $accountId: String!
    $input: CreatePartPricingScaleInput!
  ) {
...
export const DeletePartPricingScaleDocument = gql`
  mutation DeletePartPricingScale(
    $accountId: String!
    $pricingScaleId: String!
  ) {
    deletePartPricingScale(
      accountId: $accountId
...
export const UpdatePartPricingScaleDocument = gql`
  mutation UpdatePartPricingScale(
    $accountId: String!
    $pricingScaleId: String!
    $input: UpdatePartPricingScaleInput!
  ) {
...
export function getSdk(
  ...
  return {
    ...
    ): Promise<CreatePartPricingScaleMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreatePartPricingScaleMutation>({
            document: CreatePartPricingScaleDocument,
            variables,
    ...
    DeletePartPricingScale(
      variables: DeletePartPricingScaleMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DeletePartPricingScaleMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeletePartPricingScaleMutation>({
            document: DeletePartPricingScaleDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    GetPartPricingScale(
      variables: GetPartPricingScaleQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<GetPartPricingScaleQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPartPricingScaleQuery>({
            document: GetPartPricingScaleDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    ListPartPricingScales(
      variables: ListPartPricingScalesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<ListPartPricingScalesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ListPartPricingScalesQuery>({
            document: ListPartPricingScalesDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    UpdatePartPricingScale(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<UpdatePartPricingScaleMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdatePartPricingScaleMutation>({
            document: UpdatePartPricingScaleDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
